if flipx
    ...
    image_xscale = 1
myspr = sprite_index
fangspr = sAutHordeFang
clawspr = sAutHordeClaw
if frozen
{
    fangspr = sAutHordeFangFrozen
    clawspr = sAutHordeClawFrozen
}
else
{
    fangspr = sAutHordeFang
...
if (flashing == 0)
{
    ...
    if (frozen > 0 && frozen < (freezetime * 0.2))
    {
        ...
        draw_sprite_ext(clawspr, -1, ((x - clawx) + 1), (y + clawy), -1, 1, (360 - clawangle), -1, (1 - (fxtimer * 0.25)))
...
else if flashing
{
    ...
    repeat (3)
        draw_sprite_ext(fangspr, -1, x, (y + fangy), image_xscale, 1, image_angle, -1, (1 - (fxtimer * 0.25)))
    draw_set_blend_mode(bm_normal)
    draw_sprite_ext(clawspr, -1, ((x - clawx) + 1), (y + clawy), -1, 1, (360 - clawangle), make_color_rgb(80, 80, 80), image_alpha)
    draw_set_blend_mode(bm_add)
    draw_sprite_ext(clawspr, -1, ((x - clawx) + 1), (y + clawy), -1, 1, (360 - clawangle), -1, (1 - (fxtimer * 0.25)))
    draw_set_blend_mode(bm_normal)
