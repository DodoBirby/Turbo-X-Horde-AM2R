...
else
{
    ...
    if (state >= 20)
    {
        ...
        draw_sprite_ext(sMonsterEyes, iframe, x, (y - 4), eyes_scale, eyes_scale, image_angle, image_blend, image_alpha)
        draw_set_blend_mode(bm_add)
        draw_sprite_ext(sMEgg, -1, x, y, scale, scale, image_angle, image_blend, (image_alpha * 0.5))
        draw_set_blend_mode(bm_normal)
        draw_sprite_ext(sMEgg, shell_frame, x, y, scale, scale, image_angle, image_blend, image_alpha)
    }
}
