if queenHealthResetQueued
{
    if (instance_exists(oQueen) && instance_exists(oQueenHead) && (!is_undefined(oQueenHead.myhealth)) && (!is_undefined(oQueen.phase)))
    {
        ...
        if (phase >= 1 && instance_exists(147756))
        {
        ...
        if (phase >= 2 && instance_exists(147757) && instance_exists(147752))
        {
        ...
        if (phase >= 3 && instance_exists(147758) && instance_exists(147746))
        {
        ...
        if (phase >= 4 && instance_exists(147759))
        {
