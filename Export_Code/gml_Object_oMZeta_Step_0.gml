...
if (state == 9)
{
    ...
    if (((facing == 1 && collision_line(x, (y + 40), (x + 60), (y + 40), oSolid, false, true)) || (facing == -1 && collision_line(x, (y + 40), (x - 60), (y + 40), oSolid, false, true))) && statetime < xtdash)
    {
        statetime = xtdash
        xVel = 0
    }
    if (statetime > xtdash2)
    {
        xVel *= 0.7
        blur = 0
        if (floor(fleg_frame) != 8)
