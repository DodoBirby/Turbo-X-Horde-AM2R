...
if (state == 1)
{
    if ((!boosting) || lock)
    {
        ...
        if (point_distance(x, y, ((tgt1x[tgt] * (-facing)) + (640 * ((1 + facing) / 2))), tgt1y[tgt]) < 32 && speed != 0)
        {
            ...
            {
                if (xtreme == 1 && (tgt == 2 || tgt == 8 || tgt == 14))
                    event_user(4)
                tgt += 1
            }
            else
        ...
        {
            if (statetime < 300)
                turnspeed = (((6 + (phase * 2)) + xtreme) + (4 * sign(boosting)))
...
if (state == 2)
{
    if ((!boosting) || lock)
    {
        ...
        if (point_distance(x, y, ((tgt2x[tgt] * (-facing)) + (640 * ((1 + facing) / 2))), tgt2y[tgt]) < 32 && speed != 0)
        {
            ...
            {
                if (xtreme == 1 && (tgt == 4 || tgt == 8 || tgt == 12))
                    event_user(4)
                tgt += 1
            }
            else
    ...
    else
    {
        ...
        if (point_distance(x, y, ((tgt5x[tgt] * (-facing)) + (640 * ((1 + facing) / 2))), tgt5y[tgt]) < 32 && speed != 0)
        {
            ...
            {
                if (xtreme == 1 && (tgt == 3 || tgt == 9 || tgt == 13))
                    event_user(4)
                tgt += 1
            }
            else
...
if (state == 3)
{
    if ((!boosting) || lock)
    {
        ...
        if (point_distance(x, y, ((tgt3x[tgt] * (-facing)) + (640 * ((1 + facing) / 2))), tgt3y[tgt]) < 32 && speed != 0)
        {
            ...
            {
                if (xtreme == 1 && (tgt == 2 || tgt == 10 || tgt == 14))
                    event_user(4)
                tgt += 1
            }
            else
