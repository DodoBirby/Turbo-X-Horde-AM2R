...
if (global.icemissiles == 0)
    op[num_IceToggle].optext = get_text("GlobalOptions", "Disabled")
else
    op[num_IceToggle].optext = get_text("GlobalOptions", "Enabled")
if (global.semiauto == 0)
    op[num_Hyper].optext = get_text("GlobalOptions", "Disabled")
else
    op[num_Hyper].optext = get_text("GlobalOptions", "Enabled")
if (global.mod_espresso_unlocked == 0)
{
    op[num_IceToggle].optext = get_text("ExtrasMenu", "Locked")
    op[num_Hyper].optext = get_text("ExtrasMenu", "Locked")
}
