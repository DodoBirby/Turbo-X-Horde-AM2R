var widescreen, lum, col, purple_glow, green_glow, eyec;
...
with (oAutoHordeBG)
{
    if (image_index > 0)
    {
        draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), 1, 1, 0, c_blue, image_alpha)
        draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), -1, 1, 0, c_blue, image_alpha)
        draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), 1, -1, 0, c_blue, image_alpha)
        draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), -1, -1, 0, c_blue, image_alpha)
    }
...
with (oAutoHorde)
{
    if (image_index == 0)
        ...
        eyec = make_color_rgb(0, 234, 125)
    else if (image_index == 1)
        eyec = make_color_rgb(255, 0, 220)
    else if (image_index == 3)
        eyec = make_color_rgb(230, 169, 0)
    else
        eyec = 16777215
    draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), 1, 1, 0, eyec, image_alpha)
    draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), -1, 1, 0, eyec, image_alpha)
    draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), 1, -1, 0, eyec, image_alpha)
    draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), -1, -1, 0, eyec, image_alpha)
}
with (oHordeFlameSpit)
{
    draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), 0.75, 0.75, 0, c_orange, image_alpha)
    draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), -0.75, 0.75, 0, c_orange, image_alpha)
    draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), 0.75, -0.75, 0, c_orange, image_alpha)
    draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), -0.75, -0.75, 0, c_orange, image_alpha)
}
with (oAutohordeStatus)
{
    draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), 0.75, 0.5, 0, make_color_rgb(0, 0, dim), image_alpha)
    draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), -0.75, 0.5, 0, make_color_rgb(0, 0, dim), image_alpha)
    draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), 0.75, -0.5, 0, make_color_rgb(0, 0, dim), image_alpha)
    draw_sprite_ext(sLight0, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), -0.75, -0.5, 0, make_color_rgb(0, 0, dim), image_alpha)
}
with (oHordeArea3Spit)
    draw_sprite_ext(sGElectLight, -1, (x - view_xview[widescreen]), (y - view_yview[widescreen]), 1, 1, image_angle, image_blend, 1)
