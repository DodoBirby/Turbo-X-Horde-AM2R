...
if (state == 2)
{
    ...
    if (statetime == 80)
    {
        ...
        if (attack == 1)
        {
            ...
            prj1.hspeed = (3 - xtreme)
            prj2.hspeed = (-3 + xtreme)
            prj3.hspeed = (6 + xtreme)
            prj4.hspeed = (-6 - xtreme)
            prj5.hspeed = (9 + xtreme)
            prj6.hspeed = (-9 - xtreme)
            sfx_play(sndBoss1FBall)
        }
        if (attack == 2)
        {
            ...
            prj3 = instance_create(x, (y + 24), oHornoad)
            prj1.image_xscale = -1
        ...
        if (attack == 3)
        {
            ...
            prj1.hspeed = (0.4 - (0.1 * xtreme))
            prj1.time = 60
            prj2.hspeed = (-0.4 + (0.1 * xtreme))
            prj2.time = 70
            prj3.hspeed = 1.2
            prj3.time = 80
            prj4.hspeed = -1.2
            prj4.time = 90
            prj5.hspeed = (2 + xtreme)
            prj5.time = 100
            prj6.hspeed = (-2 - xtreme)
            prj6.time = 110
            sfx_play(sndBoss1FBall)
        }
    }
