...
if (plantdrain > 0)
{
    ...
    else if (instance_exists((956 || instance_exists(oBlobWater))) && state != 60)
    {
        switch global.currentsuit
        {
            case 0:
                ...
                break
            case 1:
                global.playerhealth -= (0.1 * oControl.mod_diffmult)
                break
            case 2:
                global.playerhealth -= (0.05 * oControl.mod_diffmult)
                break
        }
