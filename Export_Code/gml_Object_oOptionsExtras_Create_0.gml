...
num_IceToggle = tempnumcounter++
num_Hyper = tempnumcounter++
...
tip[num_IceToggle] = get_text("ExtrasMenu", "IceToggle_Tip")
tip[num_Hyper] = get_text("ExtrasMenu", "HyperMode_Tip")
